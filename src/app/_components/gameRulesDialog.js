  ...
  return (
    <div className="text-gray-800 cursor-pointer text-sm md:text-lg border-2 border-blue-300 w-8 h-8 md:h-12 md:w-12 rounded-full content-center">
      ...
      >
        ...
        <p className="mb-4">
          Welcome to a solitaire version of The Game! Here are the basic rules:
        </p>
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            Select the card from your "hand" and then the pile to place the card
            on.
          </li>
          ...
          <li>
            Each round you will begin with six (6) cards that can be played. You
            must play at least 2 cards before you can move to you next hand. The
            current hand is displayed for each round.
          </li>
          <li>
            The highest card wins the round, and the player with the most round
            wins is the overall winner.
          </li>
          <li>
